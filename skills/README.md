...
live directly in `data/`, while raw scraper artifacts live in `data/scrapers/`.
...
python -m skills.matcher data --output data/delhaize_mapping.csv
```
...
```bash
python -m skills.ocr data/scrapers/delhaize/2025_01_20.jpg --output-dir data
```
